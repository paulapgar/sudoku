...
function setBoard(puzzleSelected:string) : Board {
     ...
     switch (puzzleSelected) {
          ...
          case "Puzzle38":
               board = new Board(9);
               board.setCellKnown(1,0,1); board.setCellKnown(3,0,7); board.setCellKnown(5,0,8); board.setCellKnown(6,0,9); board.setCellKnown(0,1,3);
               board.setCellKnown(5,1,9); board.setCellKnown(7,1,8); board.setCellKnown(4,2,5); board.setCellKnown(5,2,2); board.setCellKnown(8,2,6);
               board.setCellKnown(0,3,8); board.setCellKnown(4,3,7); board.setCellKnown(6,3,2); board.setCellKnown(7,3,4); board.setCellKnown(8,3,9);
               board.setCellKnown(2,4,4); board.setCellKnown(3,4,8); board.setCellKnown(4,4,9); board.setCellKnown(5,4,3); board.setCellKnown(6,4,1);
               board.setCellKnown(0,5,9); board.setCellKnown(1,5,5); board.setCellKnown(2,5,7); board.setCellKnown(4,5,4); board.setCellKnown(8,5,3);
               board.setCellKnown(0,6,7); board.setCellKnown(3,6,9); board.setCellKnown(4,6,2); board.setCellKnown(1,7,6); board.setCellKnown(3,7,3);
          ...
          case "Puzzle94":
               board = new Board(9);
               board.setCellKnown(1,0,3); board.setCellKnown(2,0,1); board.setCellKnown(0,1,7); board.setCellKnown(2,1,8); board.setCellKnown(4,1,2);
               board.setCellKnown(8,1,1); board.setCellKnown(3,2,8); board.setCellKnown(6,2,4); board.setCellKnown(1,3,7); board.setCellKnown(4,3,3);
               board.setCellKnown(5,3,6); board.setCellKnown(1,4,4); board.setCellKnown(2,4,6); board.setCellKnown(6,4,2); board.setCellKnown(7,4,3);
               board.setCellKnown(3,5,5); board.setCellKnown(4,5,7); board.setCellKnown(7,5,4); board.setCellKnown(2,6,5); board.setCellKnown(5,6,8);
               board.setCellKnown(0,7,6); board.setCellKnown(4,7,5); board.setCellKnown(6,7,1); board.setCellKnown(8,7,2); board.setCellKnown(6,8,3);
               board.setCellKnown(7,8,6);
               return board;
               break;
          case "Puzzle174":
               board = new Board(9);
